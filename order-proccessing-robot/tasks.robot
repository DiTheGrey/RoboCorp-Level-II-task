...
Take a screenshot of the robot
    ...
    Sleep   1sec
    Log To Console                  Taking Screenshot to ${fully_qualified_img_filename}
...
Embed the robot screenshot to the receipt PDF file
    ...
    # List of files that is to be added to the PDF
 ...
 Get Author Name
    ...
    Log                     ${secret}[wrotethis] wrote this program for you      console=yes

Get The User Name
    Add heading             RoboCorp Order Genie
    Add text input          myname    label=Hi! What is your name?     placeholder=Input name here
    ${result}=              Run dialog
...
Display the success dialog
    ...
    Add text      Dear ${USER_NAME} - all orders have been processed. Have a lovely day!
